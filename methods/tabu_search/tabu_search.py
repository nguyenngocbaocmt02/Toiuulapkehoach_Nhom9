...
class TabuSearch:
    def __init__(self, tabu_list_length, max_iterations, n_neighbors, intensification_factor, local_search_prob):
    ...
    def solve(self, instance):
        ...
        for iteration in range(self.max_iterations):
            ...
            print(best_cost)
        return self.decode(best_individual, len(distance_matrix)), best_cost
